                    ...
                    {block.type === 'text' ? (
                      ...
                      <div className="space-y-3">
                        <ImageUploader 
                          ...
                          onChange={(url) => handleUpdateBlock(index, { type: 'image', src: url, alt: (block as any).alt })}
                          domain="product"
                          usage="detail"
                          entityId={product.id}
                          height="160px"
                        ...
                        <input 
                          ...
                          onChange={(e) => handleUpdateBlock(index, { type: 'image', src: (block as any).src, alt: e.target.value })}
                    ...
                    if (block.type === 'text') {
                      return (
                        <div 
                          ...
                          dangerouslySetInnerHTML={{ __html: (block as any).content || '<p class="text-gray-300 italic">빈 텍스트 블록</p>' }}
                        />
                      );
                      ...
                      return <img key={i} src={src} alt={(block as any).alt || ''} className="w-full h-auto block" />;
                    } else {
