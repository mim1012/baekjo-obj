  ...
  return (
    <header className="border-b border-[#E7E0D5] bg-[#FBFAF7]">
      <div className="site-container-wide flex h-16 items-center justify-between lg:h-[72px]">
        ...
        <Link
          href="/"
          className="inline-flex min-h-11 items-center gap-2 rounded-full px-3 py-2 text-sm font-semibold text-[#59615B] transition-colors duration-500 hover:bg-[#F3EEE6] hover:text-[#17211D]"
        >
