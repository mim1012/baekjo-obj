...
interface ReviewsSectionProps {
  ...
  onEditReview: (review: ProductReview, product: any, optionName?: string) => void;
...
export default function ReviewsSection({
  ...
  const activeItems = subTab === 'writable' ? writableItems : sortedReviews;
    ...
    <section>
      ...
      {totalItems === 0 ? (
        ...
        <div className="flex flex-col gap-4">
          {subTab === 'writable'
            ? paginatedItems.map((data: any, idx) => {
