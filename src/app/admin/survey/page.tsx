              ...
              <button onClick={() => {
                const ruleToAdd = {
                  ...
                  recommendation: {
                    ...
                    categorySlug: (newRule.recommendation as any)?.categorySlug || '',
                    brandIds: newRule.recommendation?.brandIds || [],
                    productIds: newRule.recommendation?.productIds || [],
                    needInsuranceAnalysis: (newRule.recommendation as any)?.needInsuranceAnalysis || false,
                    recommendKit: (newRule.recommendation as any)?.recommendKit || false,
                  }
                };
