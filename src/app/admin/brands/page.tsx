              ...
              <div className="bg-white rounded-xl shadow-xl w-full max-w-lg overflow-hidden flex flex-col">
                ...
                <div className="p-6 space-y-4">
                  <div>
                    ...
                    <input type="text" className="w-full border border-[#D1D0C8] rounded-md px-3 py-2 text-sm" placeholder="상품 이름" />
                  </div>
                  <div>
                    <label className="block text-xs font-semibold text-[#59615B] mb-1.5">소속 브랜드 지정</label>
                    <select className="w-full border border-[#D1D0C8] rounded-md px-3 py-2 text-sm bg-white" defaultValue={activeBrandId || ''}>
            ...
            <div className="absolute inset-0 z-50 bg-black/40 flex items-center justify-center p-4 backdrop-blur-sm">
              <div className="bg-white rounded-xl shadow-xl w-full max-w-lg overflow-hidden flex flex-col">
                ...
                <div className="px-6 py-4 border-t border-[#D1D0C8] bg-slate-50 flex justify-end gap-2">
                  ...
                  <button onClick={() => setIsAddingBrand(false)} className="px-4 py-2 text-sm font-medium text-white bg-[#2F3B34] rounded-md hover:bg-[#1f2823]">브랜드 생성</button>
                </div>
              </div>
            </div>
          )}
