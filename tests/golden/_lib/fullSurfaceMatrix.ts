...
export const FULL_SURFACE_DOMAINS: readonly FullSurfaceDomain[] = [
  ...
  },
  {
    ...
    operations: ['create', 'recommended-product-link', 'delete', 'public-detail'],
    evidenceNeedles: ['/admin/concerns', '/concerns/${expectedSlug}', '추천 상품'],
    status: 'partial',
  ...
  },
  {
    key: 'partnerships',
    label: '제휴 문의 관리',
    adminPages: ['/admin/partner-inquiries'],
    adminApiRoutes: [
      '/api/admin/partner-inquiries',
      '/api/admin/partner-inquiries/[id]',
    ],
    publicOrMemberSurfaces: ['/landing/care-kit#partner'],
    goldenSpecs: ['admin-crud-partner-inquiries.spec.ts'],
    operations: ['public-inquiry-create', 'status-change', 'memo-update', 'delete'],
    evidenceNeedles: ['/landing/care-kit#partner', '/admin/partner-inquiries', '새로고침 후 영속'],
    status: 'verified',
  },
  {
    key: 'care-kits',
    ...
    goldenSpecs: ['admin-crud-kits.spec.ts'],
